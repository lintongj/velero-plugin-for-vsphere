...
In the environment of vSphere with Kubernetes, users are supposed to
use `Velero vSphere Operator` to deploy velero-plugin-for-vsphere as well as velero.
For more detail, please refer to the [user manual](supervisor-operator-user-manual.md).
